...
mp_face_mesh = mp.solutions.face_mesh  # ml solutions provided by mediapipe
...
cap = cv2.VideoCapture(0)   # webcam data is stored in that variable

item = 0

while cap.isOpened():
    success, image = cap.read()  # readed image from webcam stored in image variable
